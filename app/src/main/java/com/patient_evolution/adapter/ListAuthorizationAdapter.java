...
public class ListAuthorizationAdapter extends ArrayAdapter {
    ...
    public ListAuthorizationAdapter(@NonNull Context context, @LayoutRes int resource, @IdRes int textViewResourceId, @NonNull List<HashMap<String, String>> original, Comparator<HashMap<String, String>> comparator) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        text1.setText("Authorization: " + filtered.get(position).get(DAO.COLUMN_AUTHORIZATION));
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            ...
            if (prefix.length() == 0) {
                ...
                for (int i = 0; i < count; i++) {
                    ...
                    if (authorization.contains(prefix) || hospital.contains(prefix) || patient.contains(prefix)) {
                        nlist.add(item);
                    }
                }
